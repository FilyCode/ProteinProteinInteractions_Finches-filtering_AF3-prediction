...
from tqdm import tqdm # Use tqdm.notebook for Jupyter/IPython, or tqdm for scripts
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Error loading files: {e}. Make sure 'data/' directory exists and files are present.")
        exit(1)

    # For testing purposes we reduce dataset
    # human_proteom_df = human_proteom_df[:400]
    ...
    # Get lists of (identifier, sequence) tuples for easier iteration
    ...
    if args.resume and output_file_exists_before_run:
        ...
        try:
            # Read all existing data. This is the memory bottleneck for extremely large files,
